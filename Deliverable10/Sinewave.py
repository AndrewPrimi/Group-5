...
# W = output
#
# This table is adjusted so that if your measured signal INTO the digipot
# is 2.5 Vpp max, then:
#   0.625 Vpp -> about 32
#   1.250 Vpp -> about 64
#   1.875 Vpp -> about 95
#   2.500 Vpp -> 127
#
# Values above 2.5 Vpp will clamp to 127 until the analog gain stage after
# the digipot is working correctly.
AMP_CAL_TABLE = {
    0.000: 0,
    0.625: 32,
    1.250: 64,
