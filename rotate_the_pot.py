...
def set_digipot_step(step_value):
    ...
    if 0 <= step_value <= MAX_STEPS:
        ...
        print(f"Pot {selected_pot + 1} | Step: {step_value:3d} | Approx: {approx_ohms:7.1f} Ohms")
    else:
...
try:
    while True:
        ...
        cb_btn = pi.callback(rotaryEncoder_pin, pigpio.FALLING_EDGE, menu_button_callback)
